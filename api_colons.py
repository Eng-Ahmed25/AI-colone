 ...
 "cells": [
  {
   ...
   "id": "9cab7855-c773-49a2-9189-08ea139cad28",
   "metadata": {},
   "outputs": [
    {
     "name": "stderr",
     ...
     "text": [
      ...
      "INFO:     Uvicorn running on http://0.0.0.0:8106 (Press CTRL+C to quit)\n"
     ]
    }
   ],
   "source": [
    ...
    "model = load_model(\"colon.h5\")  # Replace with your model path\n",
    "\n",
    ...
    "\n",
    "    config = Config(app, host=\"0.0.0.0\", port=8106)\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": None,
   "id": "636eac2f-2121-4100-a9a0-3fcc1650edcf",
   "metadata": {},
   "outputs": [],
   "source": []
  }
